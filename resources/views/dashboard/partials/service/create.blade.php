                                          ...
                                          <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                      ...
                                                      <select name="category" class="form-select">
                                                            ...
                                                            <option value="محصولات کودک">محصولات کودک</option>
                                                            <option value="دوچرخه">دوچرخه</option>
                                                            <option value="اکسسوری و لوازم جانبی">اکسسوری و لوازم جانبی</option>
                                                            <option value="تفریحات آبی">تفریحات آبی</option>
